...
export function FeedbackSuccessStep() {
  return (
    <div className='bg-zinc-900 p-4 relative rounded-2xl mb-4 flex flex-col items-center shadow-lg w-[calc(100vw-2rem)] md:w-auto'>
      <header>
        <span
          className='text-xl leading-6 flex items-center gap-2 px-8'
          title='feedback-sent'
        >
          <svg
            width='41'
      ...
      <div className='min-w-[304px] w-full min-h-[112px] flex items-center justify-center bg-zinc-800 rounded-md m-3'>
        Muito obrigado!
      </div>
